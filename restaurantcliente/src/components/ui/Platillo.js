    ...
    // context de forebase para cambios en la BD
    ...
    <label className="block mt-2 sm:w-2/4">
    ...
    <p className="font-bold text-2xl text-red-600 mb-4">{nombre}</p>

    <p className="text-gray-600 mb-4 ">Categoria: {''} 
    <span className="text-gray-700 font-bold">{categoria}</span></p>
